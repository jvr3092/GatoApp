...
public class GameEActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_e);

        man = getIntent().getCharExtra("manPlay", 'O');
        com = getIntent().getCharExtra("comPlay", 'X');
        principal.initialize();

        btn1 = (Button) findViewById(R.id.btne1);
        btn2 = (Button) findViewById(R.id.btne2);
        btn3 = (Button) findViewById(R.id.btne3);
        btn4 = (Button) findViewById(R.id.btne4);
        btn5 = (Button) findViewById(R.id.btne5);
        btn6 = (Button) findViewById(R.id.btne6);
        btn7 = (Button) findViewById(R.id.btne7);
        btn8 = (Button) findViewById(R.id.btne8);
        btn9 = (Button) findViewById(R.id.btne9);
